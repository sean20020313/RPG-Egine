...
**關卡制（共 5 關）：** 每關 **8 隻**魔物 + 中央**首領**。通關順序與地圖主題：**草原 → 雪原 → 熔岩 → 遺跡 → 水晶**；每關有專屬造景（樹木、雪松、熔岩岩、遺跡柱、水晶叢等）。第 5 關首領擊敗即**全劇通關**。
...
**魔物種類：** 每關僅出現該關專屬魔物（含關卡限定造型）。例如草原：史萊姆／哥布林／花蔓妖；雪原：霜雪人／凍骨士兵；熔岩：火焰小鬼／炎獸人；遺跡：古代幽靈／斷垣石像；水晶：水晶碎靈／晶化史萊姆。首領亦隨關卡變化。

**首領掉落：** 擊敗關底首領會自動獲得該關獎勵道具（地圖上顯示掉落特效、訊息列顯示「首領掉落：…」），並有機率額外獲得藥草。各關獎勵大致為：草原（治療藥水、藥草）→ 雪原（強效藥水、魔力藥水）→ 熔岩／遺跡／水晶（更強恢復與魔力道具）。
...
**目前 `play/` 狀態**：**固定 2D 地圖**、**5 關**制（草原／雪原／熔岩／遺跡／水晶造景）、每關含**主題河流、村莊、橋與大量造景**、8 隻小怪 + 首領、**鍵盤**操作；全中文 HUD。
...
| 4 | 遺跡 | 遺跡骷髏、斷垣石像、遊蕩獸人、古代幽靈 | 遺跡守護者（幽靈造型） |
| 5 | 水晶 | 晶化史萊姆、棱光蝙蝠、晶網蜘蛛、水晶碎靈 | 水晶龍王（水晶碎靈造型） |
